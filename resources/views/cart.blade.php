            ...
            <div class="mb-8 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <div class="relative grid h-12 w-12 place-items-center rounded-lg bg-blue-800 text-white ">
                        ...
                        <span
                            class="absolute -right-2 -top-2 grid h-5 w-5 place-items-center rounded-full bg-white text-xs font-bold text-red-400 shadow">2</span>
                    </div>
                    <div class="text-right">
                    ...
                    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex items-center gap-3">
                                    <div
                                        ...
                                        <img src="https://images.unsplash.com/photo-1581235720704-06d3acfcb36f?w=800&q=80"
                                            alt="product"
                                            srcset="https://images.unsplash.com/photo-1581235720704-06d3acfcb36f?w=800&q=80"
                        ...
                        <div class="hidden md:flex md:items-center md:gap-16">
                            ...
                            <div
                                ...
                                <span class="w-10 text-center text-sm font-semibold">1</span>
                                <button class="px-2 py-2 text-slate-500 hover:bg-slate-50">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"
                                        class="size-4">
                                        <path
                ...
                <div class="mt-6 rounded-[14px] shadow-sm bg-white p-6">
                    <div class="grid gap text-sm">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-semibold">0$</span>
                        </div>
                        <div class="flex items-center justify-between">
                        ...
                        <div class="pt-2 flex items-center justify-between border-t border-slate-100">
                            ...
                            <span class="font-extrabold text-blue-600">61.35</span>
                        </div>
