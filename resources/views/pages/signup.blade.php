                    ...
                    <form action="#" method="POST" class="space-y-6">
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <div class="mt-2">
                                    <input id="first-name" type="text" name="first-name" required autocomplete="given-name"
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <input id="last-name" type="text" name="last-name" required autocomplete="family-name"
                                        class="block w-full rounded-lg border border-slate-200 px-4 py-2 text-sm text-slate-900 shadow-sm focus:border-[#1F4BD8] focus:outline-none focus:ring-2 focus:ring-[#1F4BD8]/20">
                                </div>
                            </div>
                        </div>
                        ...
                        <label class="flex items-start gap-2 text-sm text-slate-600">
                            <input id="terms" type="checkbox" name="terms" required
                                class="mt-0.5 h-4 w-4 rounded border-slate-300 text-[#1F4BD8] focus:ring-[#1F4BD8]">
                            <span>I agree to the <a href="#" class="font-semibold text-[#1F4BD8] hover:text-[#1F4BD8]">terms</a> and <a href="#" class="font-semibold text-[#1F4BD8] hover:text-[#1F4BD8]">privacy policy</a>.</span>
                        </label>
